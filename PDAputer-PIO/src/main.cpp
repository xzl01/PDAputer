...
#include "apps/webradio/webradio_app.h"
...
WebRadioApp webRadioApp(appManager);
...
void setup() {
    ...
    // Web Radio: index 2
    webRadioApp.setBackApp(&mainMenuApp);
    mainMenuApp.setAppTarget(2, &webRadioApp);
    ...
    mainMenuApp.setAppTarget(4, &terminalApp);
